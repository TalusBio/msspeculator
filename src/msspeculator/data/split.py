...
The hash itself lives in Rust (``msspeculator_core::split``) because a library is split there
...
def assign_split(sequence: str, cfg: SplitConfig) -> Split:
    ...
    return msspeculator_rs.assign_split(sequence, cfg.salt, cfg.train, cfg.val)
